...
El objetivo general es encontrar los míninos locales de una función $ f : \mathbb{R}^n \to \mathbb{R} $ tal que $ f(x) \in\mathcal{C}^1 $ de manera iterativa. El algoritmo general se ve como
\begin{shaded*}
\begin{enumerate}
